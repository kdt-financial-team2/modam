...
public class MypageViewController {
    ...
    public String updateProfile(
        ...
        try {
            // memberService.updateProfile(userDetails.getMember().getId(), name, phoneNo);
    ...
    public String updatePassword(
            ...
            RedirectAttributes rttr) {
        try {
            // memberService.updatePassword(userDetails.getMember().getId(), currentPassword, newPassword);
    ...
    public String processWithdrawal(@AuthenticationPrincipal CustomUserDetails userDetails, RedirectAttributes rttr) {
        // TODO: 회원 탈퇴 로직 (memberService.withdraw)
        rttr.addFlashAttribute("successMsg", "회원 탈퇴가 완료되었습니다. 이용해 주셔서 감사합니다.");
        return "redirect:/"; // 성공 시 메인 홈으로
    }
